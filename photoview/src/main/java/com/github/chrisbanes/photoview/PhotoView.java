...
public class PhotoView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        for (Dot dot:dots){
            canvas.drawCircle(convertedX(dot.getX(),canvas), convertedY(dot.getY(),canvas), dot.getRadius(), dotPaint);
        }
    ...
    private void init() {
        ...
        dotPaint = new Paint();
        dotPaint.setColor(getResources().getColor(R.color.dot_color));
    }
